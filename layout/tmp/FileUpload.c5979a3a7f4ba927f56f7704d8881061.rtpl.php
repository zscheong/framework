    ...
    <body>
        <div class="container-fluid">
            ...
            <script type="text/javascript">
                ...
                //The flow Too Complicated to upload file ajax
                function LoadColumn() {
            ...
            <div class="row">
                <div class="col-sm-offset-4 col-sm-4">
                    ...
                    <h4> Excel Utility - Check Row Duplication </h4>
                        ...
                        <input type="hidden" name="view" value="DuplicateRow"/>
                        <input type="hidden" name="form_id" value="<?php echo $form_id;?>"/>
                        <!--<input type="hidden" id='multiselect' name="multiselect" value=""/>-->
                        <div class="input-group">
                            <span class="input-group-addon">Excel File</span>
                            <input type="file" class="form-control" id="excel_file" name="excel_file" placeholder="Browse an excel file..."></input>
                        </div>
